...
import com.example.chattingapp.adapters.StudentAdapter;
...
public class UsersActivity extends AppCompatActivity implements UserListener {
    ...
    private ItemContainerUserBinding binding2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding2 = ItemContainerUserBinding.inflate(getLayoutInflater());
        setListeners();
        getUsers();
    }
                ...
                .addOnCompleteListener(task -> {
                    ...
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        for (QueryDocumentSnapshot queryDocumentSnapshot : task.getResult()){
                            ...
                            //user.company = queryDocumentSnapshot.getString(Constants.KEY_COMPANY);
